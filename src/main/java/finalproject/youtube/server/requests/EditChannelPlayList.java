...
public class EditChannelPlayList implements Request {
    ...
    public void conductRequest(JSONObject request) {
        ...
        if (edit_request.equals("update_name")){
            ...
            SQLResponse = DatabaseManger.editChannelPlaylistName(new_value, playlist_id);
            ...
            SQLResponse = DatabaseManger.editChannelPlaylistCover(new_value, playlist_id);
        }
